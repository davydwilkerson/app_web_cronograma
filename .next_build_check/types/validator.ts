...
// Validate ../../src/app/api/webhook/herospark/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/webhook/herospark">> = Specific
  const handler = {} as typeof import("../../src/app/api/webhook/herospark/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
